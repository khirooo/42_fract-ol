...
/*   Updated: 2022/08/04 02:09:59 by kfergani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_complex	get_complex(t_matrix m_cord, t_mlx *info)
{
	...
	c_cord.i = (WIDTH / 2 - (double)m_cord.j + info->x_move)
		* 4 / (HEIGHT * info->zoom * 50) + info->last_mouse.i;
	c_cord.r = -(HEIGHT / 2 - (double)m_cord.i + info->y_move)
		* 4 / (WIDTH * info->zoom * 50) + info->last_mouse.r;
	return (c_cord);
}
...
t_complex	get_next_bonus(t_complex c, t_complex z)
{
	...
	c2.r = c.r * c.r * c.r - 3 * c.r * c.i * c.i + z.r;
	c2.i = 3 * c.r * c.r * c.i - c.i * c.i * c.i + z.i;
	return (c2);
}
